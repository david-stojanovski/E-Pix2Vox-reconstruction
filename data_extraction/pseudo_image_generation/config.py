...
__C.DATA.JSON_VIEW_DICT_PATH = (
    r"/path/to/your/folders/containing/pseudo_image_generation/view_param_dict.json"
)
__C.DATA.SAVE_PATH = (
    r"/path/to/your/folders/containing/pseudo_image_generation/heart_out"
)
...
__C.PARAMS.CONE_RADII = (
    1.0 * __C.PARAMS.OUT_IMG_SIZE[0]
)  # Radius of generated ultrasound cone
__C.PARAMS.SHOW_BLOODPOOL = (
    False  # bool flag of whether to plot a debug image of the found blood pools
)

__C.NOISE = edict()
__C.NOISE.DOWNSIZE_FACTOR_1 = (
    1  # Downsize factor of the 1st multiplicative noise addition
)
__C.NOISE.TYPE_1 = (
    "uniform"  # Statistical distribution of the 1st multiplicative noise addition
)
__C.NOISE.DOWNSIZE_FACTOR_2 = (
    2  # Downsize factor of the 2nd multiplicative noise addition
)
__C.NOISE.TYPE_2 = (
    "normal"  # Statistical distribution of the 2nd multiplicative noise addition
)
__C.NOISE.DOWNSIZE_FACTOR_3 = (
    6  # Downsize factor of the 3rd multiplicative noise addition
)
__C.NOISE.TYPE_3 = (
    "normal"  # Statistical distribution of the 3rd multiplicative noise addition
)
